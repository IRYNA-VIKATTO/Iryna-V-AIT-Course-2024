...
class ValidatorTest {
    ...
    void checkDateFormatUS() {
        assertTrue(Validator.checkDateFormatUS("2024-12-25"));
        assertTrue(Validator.checkDateFormatUS("2000-01-01"));
        assertTrue(Validator.checkDateFormatUS("2001-07-01"));
        assertFalse(Validator.checkDateFormatUS("2024-12-32"));
        assertFalse(Validator.checkDateFormatUS("2024-13-25"));
