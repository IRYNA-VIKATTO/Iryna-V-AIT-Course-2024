package homework_42.worte_map;
// Подсчитайте частоту использования слов в предложении Л.Н.Толстого: "В 1800-х годах, в те времена,
// когда не было еще ни железных, ни шоссейных дорог, ни газового, ни стеаринового света, ни пружинных низких диванов,
// ни мебели без лаку, ни разочарованных юношей со стеклышками, ни либеральных философов-женщин, ни милых дам-камелий,
...
public class WordFrequency {
    public static void main(String[] args) {
        ...
        text = text.replaceAll("[^a-zA-Zа-яА-ЯёЁ0-9\\s]", "").toLowerCase();
        ...
        // Выводим результаты
        System.out.println("Частота использования слов:");
