...
public class StringAppl {
    public static void main(String[] args) {
        ...
        String str2 = new String(chars);//str2 -это объект класса
        // new -это обращение к конструктору класса

        System.out.println(str1);// Hello
        System.out.println(str2);//  World!

        //concat - объеденяем складываем объекты типа String
        String str = str1 + str2;
        System.out.println(str);

        str1.concat(str2);//конкатенация с помощью метода
        System.out.println(str1.concat(str2));
        System.out.println(str1);// str1 не изменилась т к тип String immutable

        // length of String
        int l = str.length();//объкт точка метод .определяем длину строки str
