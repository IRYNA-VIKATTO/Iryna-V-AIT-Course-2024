...
class CityTest {
    ...
    void setUp() {
        ...
        cities[4] = new City("New Yor",8_500_000);
   ...
   void testComparable(){
       ...
       Arrays.sort(cities);
       printArray(cities,": List of cities sortted by population");
...
//Проверьте работу метода System.arraycopy, скопировав часть массива.
    ...
    void testSystemArrayCopy(){
        ...
        System.arraycopy(cities, 1,citiesCopyPlus2, 1,3);
    ...
    void testArraysCopyOfRange(){
        ...
        City[] citiesCopy = Arrays.copyOfRange(cities, 1,cities.length + 3);
